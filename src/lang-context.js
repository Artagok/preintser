...
export const langs = {
  ca: {
    ...
    contact: {
      box: {
        title: "Contacte",
        location1: "Carrer de la Garrotxa, 7-9",
        location2: "Local 6, 08041 Barcelona",
        map: "Veure al mapa",
  ...
  es: {
    ...
    contact: {
      box: {
        title: "Contacto",
        location1: "Calle de la Garrotxa, 7-9",
        location2: "Local 6, 08041 Barcelona",
        map: "Ver en mapa",
        days: "Lunes - Viernes",
        hours1: "10:00h - 13:00h",
  ...
  en: {
    ...
    contact: {
      box: {
        title: "Contact",
        location1: "Garrotxa Street, 7-9",
        location2: "Premises 6 08041 Barcelona",
        map: "See on map",
        days: "Monday - Friday",
        hours1: "10 AM - 1 PM",
        hours2: "5 PM - 8 PM"
